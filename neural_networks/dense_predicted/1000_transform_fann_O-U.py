...
if __name__ == "__main__":
    ...
    X_train_file = "X_train_O_1000.npy"
    Y_train_file = "Y_train_O_1000.npy"
    ...
    X_train_file = "X_test_O_1000.npy"
    Y_train_file = "Y_test_O_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_P_1000.npy"
    Y_train_file = "Y_train_P_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_P_1000.npy"
    Y_train_file = "Y_test_P_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_Q_1000.npy"
    Y_train_file = "Y_train_Q_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_Q_1000.npy"
    Y_train_file = "Y_test_Q_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_R_1000.npy"
    Y_train_file = "Y_train_R_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_R_1000.npy"
    Y_train_file = "Y_test_R_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_S_1000.npy"
    Y_train_file = "Y_train_S_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_S_1000.npy"
    Y_train_file = "Y_test_S_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_T_1000.npy"
    Y_train_file = "Y_train_T_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_T_1000.npy"
    Y_train_file = "Y_test_T_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_U_1000.npy"
    Y_train_file = "Y_train_U_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_U_1000.npy"
    Y_train_file = "Y_test_U_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
