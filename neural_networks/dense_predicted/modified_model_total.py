...
A_train_input_dim=A_train_output_dim=B_train_input_dim=B_train_output_dim=0
C_train_input_dim=C_train_output_dim=D_train_input_dim=D_train_output_dim=0
E_train_input_dim=E_train_output_dim=F_train_input_dim=F_train_output_dim=0
G_train_input_dim=G_train_output_dim=H_train_input_dim=H_train_output_dim=0
I_train_input_dim=I_train_output_dim=J_train_input_dim=J_train_output_dim=0
K_train_input_dim=K_train_output_dim=L_train_input_dim=L_train_output_dim=0
M_train_input_dim=M_train_output_dim=N_train_input_dim=N_train_output_dim=0
O_train_input_dim=O_train_output_dim=P_train_input_dim=P_train_output_dim=0
Q_train_input_dim=Q_train_output_dim=R_train_input_dim=R_train_output_dim=0
S_train_input_dim=S_train_output_dim=T_train_input_dim=T_train_output_dim=0
U_train_input_dim=U_train_output_dim=pos_train_input_dim=pos_test_output_dim=0
form_train_input_dim=form_train_output_dim=0

A_test_input_dim=A_test_output_dim=B_test_input_dim=B_test_output_dim=0
C_test_input_dim=C_test_output_dim=D_test_input_dim=D_test_output_dim=0
E_test_input_dim=E_test_output_dim=F_test_input_dim=F_test_output_dim=0
G_test_input_dim=G_test_output_dim=H_test_input_dim=H_test_output_dim=0
I_test_input_dim=I_test_output_dim=J_test_input_dim=J_test_output_dim=0
K_test_input_dim=K_test_output_dim=L_test_input_dim=L_test_output_dim=0
M_test_input_dim=M_test_output_dim=N_test_input_dim=N_test_output_dim=0
O_test_input_dim=O_test_output_dim=P_test_input_dim=P_test_output_dim=0
Q_test_input_dim=Q_test_output_dim=R_test_input_dim=R_test_output_dim=0
S_test_input_dim=S_test_output_dim=T_test_input_dim=T_test_output_dim=0
U_test_input_dim=U_test_output_dim=pos_test_input_dim=pos_test_output_dim=0
form_test_input_dim=form_test_output_dim=0
