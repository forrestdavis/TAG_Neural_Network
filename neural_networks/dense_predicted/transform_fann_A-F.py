...
if __name__ == "__main__":
    ...
    X_train_file = "X_train_A.npy"
    Y_train_file = "Y_train_A.npy"
    ...
    X_train_file = "X_test_A.npy"
    Y_train_file = "Y_test_A.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_B.npy"
    Y_train_file = "Y_train_B.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_B.npy"
    Y_train_file = "Y_test_B.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_C.npy"
    Y_train_file = "Y_train_C.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_C.npy"
    Y_train_file = "Y_test_C.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_D.npy"
    Y_train_file = "Y_train_D.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_D.npy"
    Y_train_file = "Y_test_D.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_E.npy"
    Y_train_file = "Y_train_E.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_E.npy"
    Y_train_file = "Y_test_E.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
