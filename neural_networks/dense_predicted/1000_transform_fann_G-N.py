...
if __name__ == "__main__":
    ...
    X_train_file = "X_train_H_1000.npy"
    Y_train_file = "Y_train_H_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_H_1000.npy"
    Y_train_file = "Y_test_H_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_I_1000.npy"
    Y_train_file = "Y_train_I_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_I_1000.npy"
    Y_train_file = "Y_test_I_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_J_1000.npy"
    Y_train_file = "Y_train_J_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_J_1000.npy"
    Y_train_file = "Y_test_J_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_K_1000.npy"
    Y_train_file = "Y_train_K_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_K_1000.npy"
    Y_train_file = "Y_test_K_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_L_1000.npy"
    Y_train_file = "Y_train_L_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_L_1000.npy"
    Y_train_file = "Y_test_L_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_M_1000.npy"
    Y_train_file = "Y_train_M_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_M_1000.npy"
    Y_train_file = "Y_test_M_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_N_1000.npy"
    Y_train_file = "Y_train_N_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_N_1000.npy"
    Y_train_file = "Y_test_N_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
