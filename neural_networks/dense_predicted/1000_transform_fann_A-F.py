...
if __name__ == "__main__":
    ...
    X_train_file = "X_train_A_1000.npy"
    Y_train_file = "Y_train_A_1000.npy"
    ...
    X_train_file = "X_test_A_1000.npy"
    Y_train_file = "Y_test_A_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_B_1000.npy"
    Y_train_file = "Y_train_B_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_B_1000.npy"
    Y_train_file = "Y_test_B_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_C_1000.npy"
    Y_train_file = "Y_train_C_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_C_1000.npy"
    Y_train_file = "Y_test_C_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_D_1000.npy"
    Y_train_file = "Y_train_D_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_D_1000.npy"
    Y_train_file = "Y_test_D_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_train_E_1000.npy"
    Y_train_file = "Y_train_E_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
    ...
    X_train_file = "X_test_E_1000.npy"
    Y_train_file = "Y_test_E_1000.npy"
    input_dim, output_dim = transform_fann(input_train_file, X_train_file, Y_train_file)
