...
int main(int argc, char **argv){
    ...
    const char *fann_name = "small_form.fann";
    const char *fm_name = "form.fm";
    const char *saved_input_filename = "input.bin";
    const char *saved_output_filename = "output.bin";
    const char *io_info_filename = "io.txt";
